...
async def game_loop():
    ...
    plaformaImg = pygame.transform.scale(plataformaImg, (100,30))
    ...
    inimigo1 = pygame.transform.scale(inimigo1, (70, 45))
    ...
    fases = [
            ...
            #1
        {
            ...
            "inimigos": [(930, 584), (1030,584), (1130,584), (1927, 584), (2030,584),(2150,584)],
        ...
        #2
        {
            ...
            "inimigos": [(518,584), (620,584), (720,584),(820,584),(950, 584),(867, 340),(1442, 584),(1900,584),(1765, 160)],
